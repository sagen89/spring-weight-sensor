package com.mycompany.spring_pc_scope.controller;
...
import com.mycompany.spring_pc_scope.dto.mcuconnect.SerialPortRespounse;
import com.mycompany.spring_pc_scope.dto.mcuconnect.UpdatePortNamesResponse;
import com.mycompany.spring_pc_scope.services.MCUconnectingServices;
...
public class ApiController {
    ...
    public ResponseEntity<Response> blink(@RequestBody Map<String, String> blinkAmountMap) {
        ...
        Response response = new Response();
        response.setResult(mcuConnectingServices.isMCUUsed() 
                            && mcuConnectingServices.blink(blinkAmount < 0 ? 0 : blinkAmount, 1500));
        response.setMsg("");
        return ResponseEntity.ok(response);
